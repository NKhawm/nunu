...
<head>
  ...
  <nav class=" p-1 lg:px-2 lg:py-0  bg-[#353434] shadow lg:flex lg:items-center lg:justify-between w-full ">
      ...
      <butto class="bg-[#27b4ae]  md:text-md text-gray-700 font-[Poppins] pointer-cursor duration-500 px-4 py-2 mx-2 hover:bg-[#ffafd7] hover:text-black rounded-full "><a href="login.php">
        Log in </a>
</butto> 
